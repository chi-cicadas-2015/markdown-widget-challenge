...
var TextInput = function() {
  ...
  // My Markdown converter (first draft--for Release 1)
...
var MarkdownWidget = function(inputArea, outputArea) {
  ...
  function processData() {
    ...
    view.showMarkdownText(textInput.convertToMarkdown);  // uses my model
    // view.showMarkdownText(markdown.toHTML(textInput.userInput));  // uncomment for Release 2
  }
